...
pytania = []
hajs=[1000000,500000,250000,125000,75000,40000,20000,10000,5000,2000,1000,500,0]
...
def wygranaa():
  font2 = pygame.font.SysFont('Arial', 72, True)
  while True:
    for event in pygame.event.get():
      if event.type == pygame.QUIT:
        pygame.quit()
    ...
    #screen.fill(backgroundcolor)
    screen.blit(backgroundcolor,[0,0])
    text1 = font2.render(f'Wygrana: {wygrana} zł', 1, (255, 255, 255))
...
def start():
  ...
  font = pygame.font.SysFont('Arial', 90, True)
  font2 = pygame.font.SysFont('Arial', 18, True)
  font3 = pygame.font.SysFont('Arial', 52, True)
  text='Milionerzy'
